...
import java.util.*
class BookAdapter4(private val context: Context, var bookList: List<BookDetails>) :
    RecyclerView.Adapter<BookAdapter4.BookViewHolder>() {
    ...
    private val db1 = FirebaseDatabase.getInstance().getReference("course/name1")
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    for (postSnapshot in dataSnapshot.children) {
                        ...
                        if (bookDetails?.status in listOf("reviewed") && bookDetails?.nodeName == nodeName1) {
