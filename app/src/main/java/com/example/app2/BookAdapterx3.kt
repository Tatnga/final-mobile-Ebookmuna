...
class BookAdapterx3(private val context: Context, private var bookList: List<book>) :
    RecyclerView.Adapter<BookAdapterx3.BookViewHolder>() {
    ...
    fun fetchBookList() {
        ...
        databaseReference1.child("usercourse").addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val userCourse = dataSnapshot.value.toString()
                ...
                db.addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        ...
                        for (postSnapshot in dataSnapshot.children) {
                            ...
                            if (book?.bookcourse == userCourse && (book?.bookquantity as? Int ?: 0) > 0) {
                                bookList.add(book!!)
                            }
                        }
    ...
    private fun showBookDetailsDialog(book: book) {
        ...
        textView30.text = "Available Book ${book.totalbookborrowed}"
