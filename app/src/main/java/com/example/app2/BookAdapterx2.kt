...
class BookAdapterx2(private val context: Context, private var bookList: List<book>) :
    RecyclerView.Adapter<BookAdapterx2.BookViewHolder>() {
        ...
        db.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (postSnapshot in dataSnapshot.children) {
                    ...
                    if ((book?.bookquantity as? Int ?: 0) >= 0) {
                        bookList.add(book!!)
                    }
                }
